...
namespace Chess.FigurePositionWeight
{
    public class OrdinaryChessBoardFigurePositionWeight : IFigurePositionWeight
    {
        ...
        private int GetBlackTeamWeight(FigureType figureType, Position.Position position)
        {
            int[][] weights = GetTableWeights(figureType);
            return weights[position.PositionY][position.PositionX];
        }
        
        private int GetWhiteTeamWeight(FigureType figureType, Position.Position position)
        {
            int[][] weights = GetTableWeights(figureType);
