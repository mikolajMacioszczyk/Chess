...
namespace Chess.UnitTests.BoardUnitTests
{
    [TestFixture]
    public class OrdinaryChessBoardUnitTests
    {
        ...
        public void DefaultConstructor_InitializationTest()
        {
            ...
            var blackRock = board.FigureAt(new Position.Position(0, 0));
            var whiteKnight = board.FigureAt(new Position.Position(7, 1));
            var blackBishop = board.FigureAt(new Position.Position(0, 5));
            var whiteQueen = board.FigureAt(new Position.Position(7, 3));
            var blackKing = board.FigureAt(new Position.Position(0, 4));
            var whitePawn = board.FigureAt(new Position.Position(6, 2));
        ...
        public void CopyConstructor_InitializationTest()
        {
            ...
            var destinationPosition = new Position.Position(2, 1);
            var secondDestinationPosition = new Position.Position(3, 0);
            
            // act
            var knight = baseBoard.RemoveFigure(new Position.Position(0, 1));
        ...
        public void SetRemoveOperation_Test()
        {
            ...
            var knightPosition1 = new Position.Position(2, 1);
            var knightPosition2 = new Position.Position(3, 0);
